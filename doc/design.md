...
| `micropython_get_hardware_profile_template` | ハードウェア構成のテンプレートを返す | なし |
| `micropython_read_hardware_profile` | ハードウェア構成を読み出す | `path: str = "/hardware_profile.txt"` |
| `micropython_write_hardware_profile` | ハードウェア構成を書き込む | `content: str`, `path: str = "/hardware_profile.txt"` |
...
- [x] `micropython_get_hardware_profile_template`
- [x] `micropython_read_hardware_profile` / `micropython_write_hardware_profile`
